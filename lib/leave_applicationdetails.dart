...
//   Future<void> updateLeaveStatus(String leaveId, String status, String statusType) async {
//     try {
//       // Update the managerStatus or hrStatus based on the statusType parameter
//       if (statusType == 'manager') {
//         await FirebaseFirestore.instance
//             .collection('leaveApplications')
//             .doc(leaveId)
//             .update({'managerStatus': status});
//       } else if (statusType == 'hr') {
//         await FirebaseFirestore.instance
//             .collection('leaveApplications')
//             .doc(leaveId)
//             .update({'hrStatus': status});
//       }
//     } catch (e) {
...
//             TextButton(
//               onPressed: () {
//                 updateLeaveStatus(leaveId, 'approved', 'manager');
...
//             TextButton(
//               onPressed: () {
//                 updateLeaveStatus(leaveId, 'rejected', 'manager');
//                 Navigator.of(context).pop();
...
//                       children: [
//                         ElevatedButton(
//                           onPressed: managerStatus == 'pending' ? () => _approveLeave(context, leaveId) : null,
//                           child: const Text('Approve'),
//                           style: ElevatedButton.styleFrom(backgroundColor: Colors.green),
//                         ),
//                         ElevatedButton(
//                           onPressed: managerStatus == 'pending' ? () => _rejectLeave(context, leaveId) : null,
//                           child: const Text('Reject'),
//                           style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
//                         ),
//                       ],
