...
// // // //       .where('department', isEqualTo: userDepartment) // Filter by department
// // // //       .snapshots(),
// // // //   builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
// // // //     if (snapshot.connectionState == ConnectionState.waiting) {
// // // //       return const Center(child: CircularProgressIndicator());
// // // //     }
// // // //     int leaveRequestCount = snapshot.data?.docs.length ?? 0;
// // // //     print('Total leave requests for department $userDepartment: $leaveRequestCount');
// // // //     return DashboardCard(
// // // //       icon: Icons.pending_actions,
// // // //       title: "Leave",
// // // //       count: leaveRequestCount,
...
// // //                     stream: FirebaseFirestore.instance
// // //                         .collection('leaveApplications')
// // //                         .where('department', isEqualTo: currentUserDepartment) // Filter by department
// // //                         .snapshots(),
// // //                     builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
// // //                       if (snapshot.connectionState == ConnectionState.waiting) {
// // //                         return const Center(child: CircularProgressIndicator());
// // //                       }
// // //                       int leaveRequestCount = snapshot.data?.docs.length ?? 0;
// // //                       print('Total leave requests for department $currentUserDepartment: $leaveRequestCount');
// // //                       return DashboardCard(
// // //                         icon: Icons.pending_actions,
// // //                         title: "Leave",
// // //                         count: leaveRequestCount,
...
// // //       .collection('leaveApplications')
// // //       .where('managerStatus', isEqualTo: 'approved')
// // //       .where('department', isEqualTo: currentUserDepartment) // Filter by current user's department
// // //       .snapshots(),
// // //   builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
// // //     if (snapshot.connectionState == ConnectionState.waiting) {
// // //       return const Center(child: CircularProgressIndicator());
...
//                           Navigator.push(
//                             context,
//                             MaterialPageRoute(builder: (context) => const ManagerLeaveStatusPage()),
//                           );
//                         },
//                       );
//                     },
