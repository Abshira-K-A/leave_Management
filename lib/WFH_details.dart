...
class WorkFromHomeDetailsPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('workFromHomeRequests') // Replace with your collection name
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView(
            children: snapshot.data!.docs.map((doc) {
              ...
              String employeeName = doc['name'] ?? 'N/A';
              String email = doc['email'] ?? 'N/A';
              DateTime requestDate = (doc['requestDate'] as Timestamp).toDate();
